...
import com.lego.yxl.core.msg.sender.support.LocalMessage;
import com.lego.yxl.core.msg.sender.support.LocalMessageRepository;
...
public class TestMessageSenderController {
    ...
    public void loadAndSend() throws InterruptedException {
        ...
        {
            // 检测消息表中存在待处理的任务
            List<LocalMessage> localMessages = localMessageRepository
                    .loadNotSuccessByUpdateGt(DateUtils.addSeconds(new Date(), -60), 100);
