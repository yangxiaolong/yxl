package com.lego.yxl.core.command.support.method;

import ch.qos.logback.core.joran.util.beans.BeanUtil;
import com.google.common.collect.Lists;
import com.lego.yxl.core.command.support.AggRoot;
import com.lego.yxl.core.command.CommandForUpdate;
import com.lego.yxl.core.command.support.handler.CommandHandler;
import com.lego.yxl.core.command.support.handler.UpdateAggCommandHandler;
import com.lego.yxl.core.command.support.handler.bizmethod.DefaultBizMethod;
...
public class UpdateServiceMethodInvokerFactory
    ...
    public ServiceMethodInvoker createForMethod(Method method) {
        ...
        for (Method aggMethod : this.getAggClass().getMethods()) {
            ...
            if (BeanUtil.isSetter(aggMethod)) {
                continue;
            }
