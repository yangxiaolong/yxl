package com.lego.yxl.core.faultrecovery.smart;

import com.lego.yxl.core.faultrecovery.annotation.Action;
...
public class ActionAspect {
    @Pointcut("@annotation(com.lego.yxl.core.faultrecovery.annotation.Action)")
